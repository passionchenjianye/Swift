...
//        let barFont = NSFontAttributeName(UIFont(name: "AvenirNextCondensed-DemiBold", size: 22.0))
        
//        if let barFont = NSFontAttributeName(UIFont(name: "AvenirNextCondensed-DemiBold", size: 22.0)){
