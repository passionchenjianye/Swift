...
class GameViewController: UIViewController {
    ...
    func initButton() {
        ...
        pauseButton.frame = CGRectMake(10, 20, buttonImage!.size.width, buttonImage!.size.height)
        pauseButton.setImage(buttonImage, forState: .Normal)
        ...
        restartButton.center = CGPointMake(view.frame.width / 2, view.frame.height / 2 + 30)
